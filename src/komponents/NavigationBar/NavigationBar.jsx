...
const Navbar = () => {
  return (
    ...
    <footer className="footer mt-100 p-10  bg-neutral text-neutral-content">
      ...
      <div>
      <span className="footer-title">Download NusaLearning Mobile</span>
      <div>
        <a href="" className="btn bg-white text-black ">Play Store</a>
        <a> or </a>
        <a href="" className="btn bg-white text-black">App Store</a>
      </div>
      </div>
    </footer>
    </div>
